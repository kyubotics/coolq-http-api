...
public:
    ...
    int32_t send_private_msg(int64_t qq, const str &msg) const {
        return CQ_sendPrivateMsg(this->ac_, qq, encode(msg, Encoding::ANSI).c_str());
    }

    int32_t send_group_msg(int64_t group_id, const str &msg) const {
        return CQ_sendGroupMsg(this->ac_, group_id, encode(msg, Encoding::ANSI).c_str());
    }

    int32_t send_discuss_msg(int64_t discuss_id, const str &msg) const {
        return CQ_sendDiscussMsg(this->ac_, discuss_id, encode(msg, Encoding::ANSI).c_str());
    }
    ...
    int32_t set_group_anonymous_ban(int64_t group_id, const str &anonymous_flag, int64_t duration) const {
        return CQ_setGroupAnonymousBan(this->ac_, group_id, encode(anonymous_flag, Encoding::ANSI).c_str(), duration);
    }
    ...
    int32_t set_group_card(int64_t group_id, int64_t qq, const str &new_card) const {
        return CQ_setGroupCard(this->ac_, group_id, qq, encode(new_card, Encoding::ANSI).c_str());
    }
    ...
    int32_t set_group_special_title(int64_t group_id, int64_t qq, const str &new_special_title, int64_t duration) const {
        return CQ_setGroupSpecialTitle(this->ac_, group_id, qq, encode(new_special_title, Encoding::ANSI).c_str(), duration);
    }
    ...
    int32_t set_friend_add_request(const str &response_flag, int32_t response_operation, const str &remark) const {
        return CQ_setFriendAddRequest(this->ac_, encode(response_flag, Encoding::ANSI).c_str(),
                                      response_operation, encode(remark, Encoding::ANSI).c_str());
    }

    int32_t set_group_add_request(const str &response_flag, int32_t request_type, int32_t response_operation) const {
        return CQ_setGroupAddRequest(this->ac_, encode(response_flag, Encoding::ANSI).c_str(),
    ...
    int32_t set_group_add_request(const str &response_flag, int32_t request_type, int32_t response_operation, const str &reason) const {
        return CQ_setGroupAddRequestV2(this->ac_, encode(response_flag, Encoding::ANSI).c_str(),
                                       request_type, response_operation, encode(reason, Encoding::ANSI).c_str());
    }
    ...
    str get_login_nick() const {
        ...
        return nick ? decode(nick, Encoding::ANSI) : str();
    }
    ...
    str get_cookies() const {
        ...
        return cookies ? decode(cookies, Encoding::ANSI) : str();
    }
    ...
    str get_app_directory() const {
        return decode(CQ_getAppDirectory(this->ac_), Encoding::ANSI);
    }
    ...
    int32_t add_log(int32_t level, const str &category, const str &msg) const {
        return CQ_addLog(this->ac_, level, encode(category, Encoding::ANSI).c_str(), encode(msg, Encoding::ANSI).c_str());
    }
